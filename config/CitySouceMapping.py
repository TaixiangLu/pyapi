...
def get_db(type, city):
    ...
    mag = {"zhuge_dm": "zhuge_dm", "ccmag": "comphousemag", "brokers": "brokers" ,"hidden_etl": "count","hidden_new": "count", "rules_template": "spider_rules"}
    if type in bj:
...
sell_new=['fs', 'jx', 'wz','xianyang','jiujiang', 'wlmq', 'bh', 'lyg','tz','zhenjiang','huzhou','yancheng','st','hd','wuhu','bt','chengde','dali','ganzhou','huaian','liuzhou','ls','mianyang','nanyang','qujing','sq','xn','xx','zhangjiakou','zhuzhou','anshan','daqing','jining','zb','zhangzhou','zj','linyi']

def getConfigName(city, type):
    if "sell" == type or "plathouse" == type:
        if city in sell_old:
            return "sell"
        else:
            return "new_sell"
